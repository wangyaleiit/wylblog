...
export const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      { path: 'index', component: _import('documentation/index'), name: 'articleList', meta: { title: 'articleList' }},
      { path: 'publishArticle', component: _import('documentation/publishArticle'), name: 'publishArticle', meta: { title: 'publishArticle' }}
    ]
  },
  {
    path: '/topicManage',
    component: Layout,
    redirect: '/topicManage/index',
    children: [
      { path: 'index', component: _import('topicManage/index'), name: 'topicManage', meta: { title: 'topicManage', icon: 'topicManage' }}
    ]
  }
]
